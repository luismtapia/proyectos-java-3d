 ...
 * @author luis
 */
public class Siniluminacion extends Applet{
    
    public static void main(String[] args) {
        Frame ventana = new MainFrame(new Siniluminacion(), 500, 500);
    }
    ...
    private Geometry lados(){
        int  array[] = {7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7}; 
        TriangleFanArray estrella = new TriangleFanArray(7+7+7+7+7+7+7+7+7+7+7+7, TriangleFanArray.COORDINATES|TriangleFanArray.COLOR_3, array);
        Point3f[] coordenadas = new Point3f[7+7+7+7+7+7+7+7+7+7+7+7];
        Color3f[] colores = new Color3f[7+7+7+7+7+7+7+7+7+7+7+7];
        Color3f verde = new Color3f(0.0f, 1.f, 0.5f);
        ...
        estrella.setCoordinates(0, coordenadas);
        estrella.setColors(0, colores);

        return estrella;
        
    }
    
    public Siniluminacion(){
