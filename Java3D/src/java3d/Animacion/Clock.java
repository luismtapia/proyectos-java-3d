 ...
 */
/*
 *      @(#)Clock.java 1.0 99/07/01 11:42:40
 *
...
//   ClockApp renders an animated analog clock
    ...
    public class Clock extends BranchGroup {
        ...
        public Clock () {
            ...
            fhHandInterp.setAxisOfRotation(faxisT3D);
            ...
            fmHandInterp.setAxisOfRotation(faxisT3D);
            ...
            bhHandInterp.setAxisOfRotation(baxisT3D);
            ...
            bmHandInterp.setAxisOfRotation(baxisT3D);
        ...
        public void setAppearance(Appearance appear) {
            ...
            Appearance bAppear = (Appearance) appear.cloneNodeComponent();
            ...
            Appearance fAppear = (Appearance) appear.cloneNodeComponent();
